...
class PortfolioBanner extends React.Component<any, any> {
        ...
        return (
            <div className='banner-card' style={{ backgroundColor: "#D00A4C" }} >
                <div className='banner-card-title' style={{ marginTop: '10px' }}>
                    <Text className='code' style={{ fontSize: '40px', color: 'white' }} color='white' content="{PORTFOLIOS}"></Text>
                    <br />
                    <br />
...
export default withRouter(PortfolioBanner)