  ...
  render(){
    return (
      <div>
        ...
        <CareerPeriod location='Nomura Information Technology' position='Senior SDE' startDate={new Date(2020,7)} descriptions={['Risk Engine, Adjustments System']}/>
        <Divider/>
        <CareerPeriod location='OKSpace Aerospace Technology' position='Software Engineer' startDate={new Date(2019,6)} endDate={new Date(2020,6)} descriptions={['XiangYun Constellation Control & Operating system design and development']}/>
        <Divider/>
        ...
        <Divider content='Skill' size={7} ></Divider>
      </div>
    )
  }
}
